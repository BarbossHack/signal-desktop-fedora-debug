...
```bash
sudo curl -so /etc/yum.repos.d/signal-desktop-barbosshack.repo "https://raw.githubusercontent.com/BarbossHack/Signal-Desktop-Fedora-Debug/refs/heads/master/repo/signal-desktop-barbosshack.repo"
